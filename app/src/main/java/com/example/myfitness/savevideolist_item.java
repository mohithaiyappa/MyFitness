...
public class savevideolist_item {
    ...
    private Bitmap trash_img = null;
    private String video_id = null;

    /**
     * 空のコンストラクタ
     */
    public savevideolist_item() {
    }
    ...
    public Bitmap getTrash_img() {
        return trash_img;
    }

    public void setTrash_img(Bitmap trash_img) {

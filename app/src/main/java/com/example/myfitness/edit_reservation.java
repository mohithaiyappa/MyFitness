...
public class edit_reservation extends AppCompatActivity {
    ...
    private final ArrayList<Reservationvideolist_item> listItems = new ArrayList<>();
    private final Calendar calendar = Calendar.getInstance();
    private final DateFormat hhmmss = new SimpleDateFormat("HH:mm:ss");
    int max_num = 1;
    ...
    private class GetSavedata extends AsyncTask<String, String, String> {
        ...
        private final ProgressDialog Dialog = new ProgressDialog(edit_reservation.this);
